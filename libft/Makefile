...
FILES	= ft_isalpha.c ft_isdigit.c ft_isascii.c ft_isprint.c ft_strlen.c \
		  ...
		  ft_putendl_fd.c ft_putnbr_fd.c ft_isalnum.c ft_strrchr.c

BFILES	= ft_lstnew_bonus.c ft_lstadd_front_bonus.c ft_lstadd_back_bonus.c \
...
$(OBJS): $(FILES) libft.h
	@gcc -Wextra -Werror -Wall $(FILES) -c
	@ar rc $(NAME) $(OBJS)
	@ranlib $(NAME)
